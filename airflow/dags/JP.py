'''
Script de airflow carga continua de datos sísmicos de Japón desde IRIS. A partir de la última hora de carga
...
import boto3
from JPhourly import main,pushS3
